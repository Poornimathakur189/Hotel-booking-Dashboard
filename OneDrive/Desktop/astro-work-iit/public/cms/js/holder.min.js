    ...
    if (e.document) {
        ...
        t.querySelectorAll || (t.querySelectorAll = function(n) {
                var r, i = t.createElement("style"),
                    a = [];
                for (t.documentElement.firstChild.appendChild(i), t._qsa = [], i.styleSheet.cssText = n + "{x-qsa:expression(document._qsa && document._qsa.push(this))}", e.scrollBy(0, 0), i.parentNode.removeChild(i); t._qsa.length;) r = t._qsa.shift(), r.style.removeAttribute("x-qsa"), a.push(r);
                return t._qsa = null, a
            ...
            function(e) {
                ...
                e.atob = e.atob || function(e) {
                    ...
                    for (; r < e.length;) n = t.indexOf(e.charAt(r)), a = a << 6 | n, o += 6, 24 === o && (i.push(String.fromCharCode(a >> 16 & 255)), i.push(String.fromCharCode(a >> 8 & 255)), i.push(String.fromCharCode(255 & a)), o = 0, a = 0), r += 1;
                    return 12 === o ? (a >>= 4, i.push(String.fromCharCode(255 & a))) : 18 === o && (a >>= 2, i.push(String.fromCharCode(a >> 8 & 255)), i.push(String.fromCharCode(255 & a))), i.join("")
                }, e.btoa = e.btoa || function(e) {
                    e = String(e);
                    var n, r, i, a, o, s, l, h = 0,
                        u = [];
                    if (/[^\x00-\xFF]/.test(e)) throw Error("InvalidCharacterError");
                    for (; h < e.length;) n = e.charCodeAt(h++), r = e.charCodeAt(h++), i = e.charCodeAt(h++), a = n >> 2, o = (3 & n) << 4 | r >> 4, s = (15 & r) << 2 | i >> 6, l = 63 & i, h === e.length + 2 ? (s = 64, l = 64) : h === e.length + 1 && (l = 64), u.push(t.charAt(a), t.charAt(o), t.charAt(s), t.charAt(l));
                    return u.join("")
                }
    ...
    return function(e) {
        ...
        (function(t) {
            ...
            function i(e, t) {
                ...
                if (n.fluid = -1 !== o.indexOf("p"), n.dimensions = {
                    ...
                    if (n.auto = w.truthy(l.auto), l.bg && (n.theme.bg = w.parseColor(l.bg)), l.fg && (n.theme.fg = w.parseColor(l.fg)), l.bg && !l.fg && (n.autoFg = !0), l.theme && n.instanceOptions.themes.hasOwnProperty(l.theme) && (n.theme = T(n.instanceOptions.themes[l.theme], null)), l.text && (n.text = l.text), l.textmode && (n.textmode = l.textmode), l.size && parseFloat(l.size) && (n.size = parseFloat(l.size)), l.font && (n.font = l.font), l.align && (n.align = l.align), l.lineWrap && (n.lineWrap = l.lineWrap), n.nowrap = w.truthy(l.nowrap), n.outline = w.truthy(l.outline), w.truthy(l.random)) {
                        ...
                        n.theme = T(n.instanceOptions.themes[d], null)
                    }
                }
                return n
            }
            ...
            function o(e) {
                ...
                "background" == i ? (a.style.backgroundImage = "url(" + r + ")", l.noBackgroundSize || (a.style.backgroundSize = h.width + "px " + h.height + "px")) : ("img" === a.nodeName.toLowerCase() ? x.setAttr(a, {
                    src: r
                }) : "object" === a.nodeName.toLowerCase() && x.setAttr(a, {
                    data: r,
                    type: "image/svg+xml"
                }), l.reRender && t.setTimeout(function() {
                    var e = n();
                    if (null == e) throw "Holder: couldn't render placeholder";
                    "img" === a.nodeName.toLowerCase() ? x.setAttr(a, {
                        src: e
                    }) : "object" === a.nodeName.toLowerCase() && x.setAttr(a, {
                        data: e,
                        type: "image/svg+xml"
            ...
            function s(e) {
                ...
                if (h.resize(e.width, e.height), o.root.add(h), e.flags.outline) {
                ...
                g.moveTo(null, null, 1), o.root.add(g);
                var m = g.textPositionData = z(o);
                ...
                if (m.lineCount > 1) {
                    var b, x = 0,
                        A = 0,
                        C = 0;
                    w = new s.Group("line" + C), ("left" === e.align || "right" === e.align) && (a = e.width * (1 - 2 * (1 - r)));
                    for (var E = 0; E < m.words.length; E++) {
                        var T = m.words[E];
                        v = new s.Text(T.text);
                        var k = "\\n" == T.text;
                        !e.noWrap && (x + T.width >= a || k === !0) && (t(g, w, x, g.properties.leading), g.add(w), x = 0, A += g.properties.leading, C += 1, w = new s.Group("line" + C), w.y = A), k !== !0 && (v.moveTo(x, 0), x += m.spaceWidth + T.width, w.add(v))
                    }
                ...
                for (var n = 0, r = t.length; r > n; n++) {
                    ...
                    if (i.holderData) {
                        ...
                        if (s) {
                            ...
                            "exact" == a.textmode && (a.exactDimensions = s, h.holderSettings.dimensions = a.dimensions), o(h)
                        } else f(i)
                    }
                }
            }
            ...
            var m = n(2),
                ...
                j = {
                    ...
                    run: function(e) {
                        ...
                        var n = {},
                            o = T(O.settings, e);
                        O.vars.preempted = !0, O.vars.dataAttr = o.dataAttr || O.setup.dataAttr, n.renderer = o.renderer ? o.renderer : O.setup.renderer, -1 === O.setup.renderers.join(",").indexOf(n.renderer) && (n.renderer = O.setup.supportsSVG ? "svg" : O.setup.supportsCanvas ? "canvas" : "html");
                        var s = x.getNodeArray(o.images),
                            l = x.getNodeArray(o.bgnodes),
                            h = x.getNodeArray(o.stylenodes),
                            u = x.getNodeArray(o.objects);
                        return n.stylesheets = [], n.svgXMLStylesheet = !0, n.noFontFallback = !!o.noFontFallback, n.noBackgroundSize = !!o.noBackgroundSize, h.forEach(function(e) {
                            ...
                            var a = null != t.data && 0 === t.data.indexOf(o.domain),
                                s = null != t.dataSrc && 0 === t.dataSrc.indexOf(o.domain);
                            a ? r(o, n, t.data, e) : s && r(o, n, t.dataSrc, e)
                            ...
                            a ? 0 === t.src.indexOf(o.domain) ? r(o, n, t.src, e) : s && (l ? r(o, n, t.dataSrc, e) : ! function(e, t, n, i, a) {
                                w.imageExists(e, function(e) {
                                    e || r(t, n, i, a)
                                })
                            }(t.src, o, n, t.dataSrc, e)) : s && r(o, n, t.dataSrc, e)
                        }), this
                    }
                },
                O = {
                ...
                z = function() {
                    ...
                    return function(r) {
                        ...
                        if (O.setup.supportsSVG) {
                            ...
                            (null == e || e.parentNode !== document.body) && (a = !0), e = b.initSVG(e, i.properties.width, i.properties.height), e.style.display = "block", a && (t = x.newEl("text", F), n = o(null), x.setAttr(t, {
                                x: 0
                            ...
                            var u = t.getBBox(),
                                d = Math.ceil(u.width / i.properties.width),
                                c = l.text.split(" "),
                                f = l.text.match(/\\n/g);
                            d += null == f ? 0 : f.length, n.nodeValue = l.text.replace(/[ ]+/g, "");
                            var p = t.getComputedTextLength(),
                                g = u.width - p,
                                m = Math.round(g / Math.max(1, c.length - 1)),
                                v = [];
                            if (d > 1) {
                                n.nodeValue = "";
                                for (var y = 0; y < c.length; y++)
                                    if (0 !== c[y].length) {
                                        n.nodeValue = w.decodeHtmlEntity(c[y]);
                                        var S = t.getBBox();
                                        v.push({
                                            text: c[y],
                                            width: S.width
            ...
            O.setup = {
                ...
                function() {
                    ...
                    e.getContext && -1 != e.toDataURL("image/png").indexOf("data:image/png") && (O.setup.renderer = "canvas", O.setup.supportsCanvas = !0), document.createElementNS && document.createElementNS(F, "svg").createSVGRect && (O.setup.renderer = "svg", O.setup.supportsSVG = !0)
                }(), c(), m && m(function() {
                    O.vars.preempted || j.run(), t.addEventListener ? (t.addEventListener("resize", g, !1), t.addEventListener("orientationchange", g, !1)) : t.attachEvent("onresize", g), "object" == typeof t.Turbolinks && t.document.addEventListener("page:change", function() {
                        j.run()
                    })
                }), e.exports = j
        }).call(t, function() {
        ...
        function n(e) {
            function t(e) {
                if (!x) {
                    if (!o.body) return i(t);
                    for (x = !0; e = S.shift();) i(e)
                }
            }

            function n(e) {
                (w || e.type === l || o[c] === d) && (r(), t())
            }

            function r() {
                w ? (o[y](m, n, h), e[y](l, n, h)) : (o[p](v, n), e[p](u, n))
            }
            ...
            return a.version = "1.4.0", a.isReady = function() {
                return x
            }, a
        }
        ...
        t.parse = function(e) {
            ...
            for (var t = {}, n = e.split("&"), r = 0; r < n.length; r++) {
                var o, h, u, d = n[r].split("="),
                    c = i(d[0]);
                if (o = s.exec(c)) t[o[1]] = t[o[1]] || [], t[o[1]][o[2]] = i(d[1]);
                else if (o = l.test(c)) {
                    for (o = c.split("."), h = t; o.length;)
                        if (u = o.shift(), u.length) {
                            if (h[u]) {
                                if (h[u] && "object" != typeof h[u]) break
                            } else h[u] = {};
                            o.length || (h[u] = i(d[1])), h = h[u]
                        }
            ...
            for (var n in e) {
                var i = e[n];
                if ("array" != o(i)) t.push(r(n) + "=" + r(e[n]));
                else
                    for (var a = 0; a < i.length; ++a) t.push(r(n + "[" + a + "]") + "=" + r(i[a]))
            }
            return t.join("&")
        }
    }, function(e, t) {
        ...
        var n = function(e) {
            ...
            a.prototype = new r;
            var o = function() {
                a.apply(this, arguments), this.type = "group"
            };
            o.prototype = new a;
            var s = function() {
                a.apply(this, arguments), this.type = "rect"
            };
            s.prototype = new a;
            var l = function(e) {
                a.call(this), this.type = "text", this.properties.text = e
            };
            l.prototype = new a;
            var h = new i;
            return this.Shape = {
        ...
        (function(e) {
            t.extend = function(e, t) {
                ...
                var t, n = /(^(?:#?)[0-9a-f]{6}$)|(^(?:#?)[0-9a-f]{3}$)/i,
                    ...
                    a = e.match(n);
                if (null !== a) return t = a[1] || a[2], "#" !== t[0] ? "#" + t : t;
                if (a = e.match(r), null !== a) return t = "rgb(" + a.slice(1).join(",") + ")";
                if (a = e.match(i), null !== a) {
                    const o = function(e) {
                            return "0." + e.split(".")[1]
                        },
                        s = a.slice(1).map(function(e, t) {
                            return 3 === t ? o(e) : e
                        });
        ...
        (function(e) {
            ...
            t.initSVG = function(e, t, n) {
                var o, s, l = !1;
                e && e.querySelector ? (s = e.querySelector("style"), null === s && (l = !0)) : (e = r.newEl("svg", i), l = !0), l && (o = r.newEl("defs", i), s = r.newEl("style", i), r.setAttr(s, {
                    type: "text/css"
                }), o.appendChild(s), e.appendChild(o)), e.webkitMatchesSelector && e.setAttribute("xmlns", i);
                for (var h = 0; h < e.childNodes.length; h++) e.childNodes[h].nodeType === a && e.removeChild(e.childNodes[h]);
                ...
                if (e.XMLSerializer) {
                    ...
                    if (n.svgXMLStylesheet) {
                        for (var s = r.createXML(), l = o.length - 1; l >= 0; l--) {
                            var h = s.createProcessingInstruction("xml-stylesheet", 'href="' + o[l] + '" rel="stylesheet"');
                            s.insertBefore(h, s.firstChild)
                        }
                        s.removeChild(s.documentElement), a = i.serializeToString(s)
                    }
                    var u = i.serializeToString(t);
                    return u = u.replace(/\&amp;(\#[0-9]{2,}\;)/g, "&$1"), a + u
                }
            }
        }).call(t, function() {
            return this
        ...
        n.rgb2hex = function(e, t, n) {
            ...
            var r = e / 60,
                ...
                a = i * (1 - Math.abs(parseInt(r) % 2 - 1)),
                o = n - i / 2,
                s = 0,
                l = 0,
                h = 0;
            return r >= 0 && 1 > r ? (s = i, l = a) : r >= 1 && 2 > r ? (s = a, l = i) : r >= 2 && 3 > r ? (l = i, h = a) : r >= 3 && 4 > r ? (l = a, h = i) : r >= 4 && 5 > r ? (s = a, h = i) : r >= 5 && 6 > r && (s = i, h = a), s += o, l += o, h += o, s = parseInt(255 * s), l = parseInt(255 * l), h = parseInt(255 * h), [s, l, h]
            ...
            var t = (16711680 & this.raw) >> 16,
                ...
                a = -.09991 * t - .33609 * n + .436 * r,
                o = .615 * t - .55861 * n - .05639 * r;
            return this.rgb = {
                r: t,
                g: n,
                b: r
            ...
            var t = Math.min(1, Math.max(0, Math.abs(e))) * (0 > e ? -1 : 1),
                ...
                a = Math.min(255, Math.max(0, this.rgb.g + r)),
                o = Math.min(255, Math.max(0, this.rgb.b + r)),
                s = n.rgb2hex(i, a, o);
            return new n(s)
            ...
            var t = e,
                ...
                a = t.alpha * t.rgb.g + (1 - t.alpha) * r.rgb.g,
                o = t.alpha * t.rgb.b + (1 - t.alpha) * r.rgb.b;
            return new n(n.rgb2hex(i, a, o))
        }, e.exports = n
    }, function(e, t) {
        e.exports = {
            version: "2.9.7",
        ...
        e.exports = function(e, t) {
            ...
            if (f.children.holderBg.properties.outline) {
                ...
                y = d.element({
                    tag: "path",
                    d: a(f.children.holderBg.width, f.children.holderBg.height, w.width),
        ...
        e.exports = function r(e, t, n) {
            ...
            function i(e) {
                var t = e.match(/^[\w-]+/),
                    ...
                    a = e.match(/\$([\w-]+)/),
                    o = e.match(/\.[\w-]+/g);
                return i && (r.attr.id = i[1], n[i[1]] = r), a && (n[a[1]] = r), o && (r.attr["class"] = o.join(" ").replace(/\./g, "")), e.match(/&$/g) && (f = !1), r
            }
            ...
            for (; c < e.length; c++) {
                ...
                if (void 0 !== e[c] && e[c] !== !0)
                    ...
                    for (h in e[c]) e[c].hasOwnProperty(h) && null !== e[c][h] && e[c][h] !== !1 && (e[0].attr[h] = "style" === h && "object" == typeof e[c][h] ? JSON.stringify(e[c][h], a).slice(2, -2).replace(/","/g, ";").replace(/":"/g, ":").replace(/\\"/g, "'") : e[c][h])
                }
            }
            if (e[0] !== !1) {
                l = "<" + e[0].tag;
                for (d in e[0].attr) e[0].attr.hasOwnProperty(d) && (l += " " + d + '="' + o(e[0].attr[d]) + '"');
        ...
        e.exports = function() {
            ...
            return function(n) {
                ...
                var r = i.canvasRatio(),
                    a = n.root;
                e.width = r * a.properties.width, e.height = r * a.properties.height, t.textBaseline = "middle";
                var o = a.children.holderBg,
                    s = r * o.width,
                    l = r * o.height,
                    h = 2,
                    u = h / 2;
                t.fillStyle = o.properties.fill, t.fillRect(0, 0, s, l), o.properties.outline && (t.strokeStyle = o.properties.outline.fill, t.lineWidth = o.properties.outline.width, t.moveTo(u, u), t.lineTo(s - u, u), t.lineTo(s - u, l - u), t.lineTo(u, l - u), t.lineTo(u, u), t.moveTo(0, u), t.lineTo(s, l - u), t.moveTo(0, l - u), t.lineTo(s, u), t.stroke());
                var d = a.children.holderTextGroup;
